...
<html lang="en">
    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p><br /><strong>1. Introduction.</strong><br />These Terms And Conditions (these &ldquo;Terms&rdquo; or these &ldquo;Terms And Conditions&rdquo;) contained<br />herein on this webpage, shall govern your use of this website, including all pages within this<br />website (collectively referred to herein below as this &ldquo;Website&rdquo;). These Terms apply in full force<br />and effect to your use of this Website and by using this Website, you expressly accept all terms<br />and conditions contained herein in full. You must not use this Website, if you have any objection<br />to any of these Website Standard Terms And Conditions.</p>
                        <p><br /><strong>2. Intellectual Property Rights.</strong><br />Other than content you own, which you may have opted to include on this Website, under these<br />Terms, Bittihattara(Toiminimi) and/or its licensors own all rights to the intellectual property and<br />material contained in this Website, and all such rights are reserved.<br />You are granted a limited license only, subject to the restrictions provided in these Terms, for<br />purposes of viewing the material contained on this Website,</p>
                        <p><br /><strong>3. Restrictions.</strong><br />You are expressly and emphatically restricted from all of the following:<br />1. using this Website in any way that is, or may be, damaging to this Website;<br />2. using this Website in any way that impacts user access to this Website;<br />3. using this Website contrary to applicable laws and regulations, or in a way that causes, or<br />may cause, harm to the Website, or to any person or business entity;<br />Certain areas of this Website are restricted from access by you and Bittihattara(Toiminimi) may<br />further restrict access by you to any areas of this Website, at any time, in its sole and absolute<br />discretion. Any user ID and password you may have for this Website are confidential and youmust maintain confidentiality of such information.</p>
                        <p><br /><strong>4. Your Content.</strong><br />In these Website Standard Terms And Conditions, &ldquo;Your Content&rdquo; shall mean any audio, video,<br />text, images or other material you choose to display on this Website. With respect to Your<br />Content, by displaying it, you grant Bittihattara(Toiminimi) a non-exclusive, worldwide,<br />irrevocable, royalty-free, sublicensable license to use, reproduce, adapt, publish, translate and<br />distribute it in any and all media.<br />Your Content must be your own and must not be infringing on any third party&rsquo;s rights.<br />Bittihattara(Toiminimi) reserves the right to remove any of Your Content from this Website at<br />any time, and for any reason, without notice.</p>
                        <p><br /><strong>5. No warranties.</strong><br />This Website is provided &ldquo;as is,&rdquo; with all faults, and Bittihattara(Toiminimi) makes no express or<br />implied representations or warranties, of any kind related to this Website or the materials<br />contained on this Website. Additionally, nothing contained on this Website shall be construed as<br />providing consult or advice to you.</p>
                        <p><br /><strong>6. Limitation of liability.</strong><br />In no event shall Bittihattara(Toiminimi), nor any of its officers, directors and employees, be<br />liable to you for anything arising out of or in any way connected with your use of this Website,<br />whether such liability is under contract, tort or otherwise, and Bittihattara(Toiminimi), including<br />its officers, directors and employees shall not be liable for any indirect, consequential or special<br />liability arising out of or in any way related to your use of this Website.</p>
                        ...
                        <p><br /><strong>9. Variation of Terms.</strong><br />Bittihattara(Toiminimi) is permitted to revise these Terms at any time as it sees fit, and by using<br />this Website you are expected to review such Terms on a regular basis to ensure you<br />understand all terms and conditions governing use of this Website.</p>
                        ...
                        <p><br /><strong>11. Entire Agreement.</strong><br />These Terms, including any legal notices and disclaimers contained on this Website, constitute<br />the entire agreement between Bittihattara(Toiminimi) and you in relation to your use of this<br />Website, and supersede all prior agreements and understandings with respect to the same.</p>
            ...
            <div style="text-align:left" class="panel panel-default">
                ...
                <div class="panel-body">
                    <h3>Getting started.</h3><hr/>
                                        ...
                                        <p>All web services are located at https://restlify.com/api/{apiKey}. <b>GET-requests can be made without any authentication.</b>
                                </div>
            </div>
             ...
             <div style="text-align:left" class="panel panel-default">
                 <div class="panel-body">
                     <h3>API</h3><hr/>
                     <pre class="prettify">
     <b>Authenticate (login information as POST-parameters)</b>
     POST /authenticate HTTP/1.1
     HOST: http://db.restlify.com
     username=yourUsername&password=yourPassword
                     </pre>

                     <pre class="prettify">
     <b>Log Out (AUTHENTICATION REQUIRED)</b>
     GET /logout HTTP/1.1
     HOST: http://db.restlify.com
                     </pre>

                     <pre class="prettify">
     <b>Create a database (body in JSON-format) (AUTHENTICATION REQUIRED)</b>
     ...
     <i>RETURNS API-key: {"apiKey":"..."}</i>
                     ...
                     <pre class="prettify">
     <b>List databases (AUTHENTICATION REQUIRED)</b>
     ...
     <i>RETURNS API-key list in JSON-format: ["{apiKey1}", "{apiKey2}", ...]</i>
                     ...
                     <pre class="prettify">
     <b>Define a class (body in JSON-format) (AUTHENTICATION REQUIRED)</b>
     ...
     <b>(When re-defining, the class must be "empty" of objects)</b>
                     ...
                     <pre class="prettify">
     <b>Define an array of classes (body in JSON-format) (AUTHENTICATION REQUIRED)</b>
     POST /define_class/{apiKey} HTTP/1.1
     HOST: http://db.restlify.com
     [
         {
     ...
     <b>(When re-defining, the classes must be "empty" of objects)</b>
                     ...
                     <pre class="prettify">
     <b>Get all class definitions (AUTHENTICATION REQUIRED)</b>
     ...
     <i>RETURNS a list of class definitions in JSON-format</i>
                     ...
                     <pre class="prettify">
     <b>Get a class definition (AUTHENTICATION REQUIRED)</b>
     ...
     <i>RETURNS a class definition in JSON-format</i>
                     ...
                     <pre class="prettify">
     <b>Destroy a class (AUTHENTICATION REQUIRED)</b>
