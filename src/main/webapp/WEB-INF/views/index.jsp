...
<html lang="en">
    ...
    <body>
            ...
            <div style="text-align:left" class="panel panel-default">
                ...
                <div class="panel-body">
                    <h3>Getting started.</h3><hr/>
                                        ...
                                        <p>All web services are located at http://restlify.com/api/{apiKey}. <b>GET-requests can be made without any authentication.</b>
                                </div>
            </div>
     ...
     HOST A: http://www.restlify.com
     HOST B: https://secure.restlify.com
